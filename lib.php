 ...
 * @return boolean
 */
function block_likes_comment_validate($comment_param) {
    if ($comment_param->commentarea != 'page_likes') {
 ...
 * @return array
 */
function block_likes_comment_permissions($args) {
    global $DB, $USER;
 ...
 * @return boolean
 */
function block_likes_comment_display($comments, $args) {
    if ($args->commentarea != 'page_likes') {
        throw new comment_exception('invalidcommentarea');
    }
    if ($args->itemid != 0) {
        throw new comment_exception('invalidcommentitemid');
